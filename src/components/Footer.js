                  ...
                  <div className="row">
                    <div className="col-xl-3 col-lg-3 col-md-12">
                      ...
                      <div className="footer-intro-wrapper">
                        ...
                        From small daily steps to big visionary goals, I’m dedicated to making things happen, one decision at a time. My journey is all about pushing limits, learning continuously, and chasing what seems impossible until it becomes possible
                        </div>
                      </div>
                    </div>
